...
function parse(buf, packet) {
  ...
  switch (frame.property)
  {
    case defines.kProperty.SPINEL_PROP_STREAM_RAW:
      ...
      break;
    case defines.kProperty.SPINEL_PROP_STREAM_NET:
    case defines.kProperty.SPINEL_PROP_STREAM_NET_INSECURE:
      frame.value = parseStreamNet(frame.value);
    default:
      break;
  }
...
function getNextPayload(parsed)
{
  if (parsed.value instanceof Buffer) return parsed.value;
  if (parsed.value.payload instanceof Buffer) return parsed.value.payload;
}

exports.parse = parse;
exports.payload = 'payload';
exports.getNextPayload = getNextPayload;
exports.name = 'Spinel';
exports.nexts = [{
  id: 'net/ip6',
}]
